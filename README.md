About colour-science-feedstock
==============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/colour-science-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5224&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/colour-science-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Installing `colour-science` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
mamba repoquery search colour-science --channel conda-forge

# List packages depending on `colour-science`:
mamba repoquery whoneeds colour-science --channel conda-forge
...
Updating colour-science-feedstock
=================================

If you would like to improve the colour-science recipe or build a new
...
Note that all branches in the conda-forge/colour-science-feedstock are
...
* [@KelSolaar](https://github.com/KelSolaar/)
